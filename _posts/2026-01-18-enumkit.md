...
── Output Location ─────────────────────
  Where should output go?
    ...
    3) Use an existing kit workspace
...
Every question has a sensible default so you can hit Enter through most of it on a standard ment. The confirmation step at the end shows exactly what will run before anything fires.
...
enumkit is designed to pair with [engagekit](/_posts/2026-01-18-engagekit.md). The workflow is:
...
Full source: [github.com/sireton/enumkit](https://github.com/sireton/tools-methodologies/blob/Practice/Tools/vuln%20testing/EnumKit/README.md)

*See also: [engagekit — Pentest Engagement Workspace Scaffolder](/_posts/2026-01-18-engagekit.md/)*
